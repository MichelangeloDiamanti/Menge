...
#ifndef __GOAL_SELECTOR_EXTERNAL_H__
#define __GOAL_SELECTOR_EXTERNAL_H__
 ...
 */
class MENGE_API ExternalGoalSelector : public GoalSelector {
 public:
  /*!
 ...
 */
class MENGE_API ExternalGoalSelectorFactory : public GoalSelectorFactory {
 public:
  /*!
   @brief    Constructor.
   */
 ...
 protected:
   ...
   */
  GoalSelector* instance() const { return new ExternalGoalSelector(); }
