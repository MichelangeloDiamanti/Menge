...
#ifndef __PERSISTENT_AGENT_GENERATOR_DATABASE_H__
#define __PERSISTENT_AGENT_GENERATOR_DATABASE_H__
 ...
 */
typedef ElementDB<PersistentAgentGeneratorFactory, PersistentAgentGenerator>
    PersistentAgentGeneratorDB;
